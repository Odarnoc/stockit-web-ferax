            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Asador circular</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="item-info-pro-ind">
                        <div class="slider-container">
                            <div class="slider" id="slider">
                                <div>
                                    <img src="images/asador-circular.jpg" alt="">
                                </div>
                                <div>
                                    <img src="images/asador-circular.jpg" alt="">
                        ...
                        <div class="d-info-pro-ind">
                            ...
                            <p class="t1">Hogar</p>
                            <p class="t2">Asador Circular</p>
                            <p class="t3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente placeat molestiae assumenda animi non velit rerum totam debitis, quibusdam tenetur voluptatibus. </p>
                    ...
                    <div class="d-checkout-pro-ind">
                        ...
                        <div class="row row-fechas-pro-ind">
                            <div class="col-md-6 col-xs-6">
                                ...
                                <label for="" class="input-date">05/Mayo/2020</label>
                            </div>
                            <div class="col-md-6 col-xs-6">
                        ...
                        <div class="row row-precio-pro-ind">
                            ...
                            <div class="col-md-6 col-xs-6">
                                <p class="t2">$ 199.<sup>00</sup></p>
                            </div>
                        </div>

                        <div class="row row-btns-pro-ind">
                            <div class="col-lg-12 col-md-12">
                                <a class="btn btn-rentar-pro-ind" href="agregar-tarjeta.html" role="button">Extender renta</a>
                            </div>
                        </div>
