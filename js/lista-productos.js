  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      data.publications.forEach(function (item) {
        ...
        var html =
          '<div class="col-lg-4 col-md-4 col-sm-6" style="paddign-top: 15px">' +
          '<div class="slide-item">' +
          '<div class="single-product">' +
          '<div class="product-img">' +
          '<a href="producto-individual.php?id=' +
          item._id +
          '">' +
          ...
          "<ul>" +
          '<li class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><a href="producto-individual.php?id=' +
          item._id +
          '" data-toggle="tooltip" data-placement="top" title="Ver producto"><i class="ion-ios-search"></i></a>' +
          "</li>" +
          '<li><a data-toggle="tooltip" onclick="favorito(\'' +
          item._id +
          '\')" data-placement="top" title="Agregar a favoritos"><i class="far fa-heart"></i></a>' +
          "</li>" +
          ...
          '<div class="product-desc_info">' +
          '<h6 class="product-name"><a href="#0">' +
          item.name +
          "</a>" +
          "</h6>" +
          '<div style="text-align: left">' +
          ...
          if (categoriaFiltro == 0 && busquedaFiltro == "") {
            ...
            if (
              String(item.name)
                .toLowerCase()
                .indexOf(busquedaFiltro.toLowerCase()) !== -1 ||
              parseInt(item.category) == parseInt(categoriaFiltro)
            ) {
              productos += html;
              cantProds++;
            }
